              ...
              ,
                ...
                mainAxisAlignment: MainAxisAlignment.center ,
                  children: [
                    ...
                    Icon( (Icons.person), color:Color.fromARGB(255, 255, 255, 255) , size: 40, ),
                    Text(" Name : " + name , style: TextStyle(fontSize: 18  , color: Color.fromARGB(255, 255, 255, 255)),),
                  Container( height:200),
                      ...
                      child: FloatingActionButton(
                        ...
                        child: const Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                                      mainAxisAlignment: MainAxisAlignment.center ,
                          children:[
                          Icon(Icons.logout , color: Color(0xff003366),size: 110,),
                          Text(" Log out " , style: TextStyle(color: Color(0xff003366) ,),)
                          
                          ],)
                        
                        
                        , onPressed: (){ print("You have been loged out ") ; }),
                    ) ,
                    Container( height:200 , width: 20,color:Color.fromARGB(0, 0, 51, 102) ,),
                    ...
                    Container(
                      ...
                      child: FloatingActionButton(
                        ...
                        child: const Column(
                          ...
                          Text(" Upload " , style: TextStyle(color: Color(0xff003366) ,),)
                      ...
                      child: FloatingActionButton(
                        ...
                        child: const Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                                      mainAxisAlignment: MainAxisAlignment.center ,
                          children:[
                          Icon(Icons.person_outline_rounded , color: Color(0xff003366),size: 110,),
                          Text(" Profile " , style: TextStyle(color: Color(0xff003366) ,),)
                      ...
                      child: FloatingActionButton(
                        ...
                        child: const Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                                      mainAxisAlignment: MainAxisAlignment.center ,
                          children:[
                          Icon(Icons.video_call_outlined , color: Color(0xff003366),size: 110,),
                          Text(" meeting " , style: TextStyle(color: Color(0xff003366) ,),)
